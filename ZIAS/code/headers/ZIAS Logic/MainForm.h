...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->_rb_climate_1->Text = L"ÐÀÉÎÍ:";
			...
			this->_l_wind_districs->Text = L"Âåòðîâîé";
			// 
			// _l_ice_districs
			// 
			...
			this->_l_ice_districs->Text = L"Ãîëîëåäíûé";
			// 
			// _l_location_types
			// 
			...
			this->_l_location_types->Text = L"ÒÈÏ ÌÅÑÒÍÎÑÒÈ";
			// 
			// _l_facing
			// 
			...
			this->_l_facing->Text = L"ÎÁËÈÖÎÂÊÀ";
			// 
			// _rb_facing_standart
			// 
			...
			this->_rb_facing_standart->Text = L"ÑÒÀÍÄÀÐÒÍÛÅ";
			...
			this->_rb_facing_unstandart->Text = L"ÍÅÑÒÀÍÄÀÐÒÍÛÅ";
			...
			this->_l_bracket->Text = L"Êðîíøòåéí";
			// 
			// _cb_bracket
			// 
			...
			this->_l_profile->Text = L"Ïðîôèëü";
			// 
			// _cb_profile
			// 
			...
			this->_l_variations->Text = L"ÂÀÐÈÀÖÈÈ";
			// 
			// _l_account
			// 
			...
			this->_chb_nvf_elements->Text = L"ýëåìåíòû ÍÂÔ";
			...
			this->_chb_nvf_connection->Text = L"ñîåäèíåíèÿ ÍÂÔ";
			...
			this->_b_calculate_account->Text = L"ðàñ÷åò";
			...
			this->_b_generate_report->Text = L"îò÷åò";
			...
			this->_l_results->Text = L"ÐÅÇÓËÜÒÀÒÛ";
			// 
			...
			this->_l_strength_extension->Text = L"Ïðî÷íîñòü óäëèíèòåëÿ -";
			// 
			// _l_strength_bracket
			// 
			...
			this->_l_strength_bracket->Text = L"Ïðî÷íîñòü êðîíøòåéíà -";
			// 
			// _l_strength_contour
			// 
			...
			this->_l_strength_contour->Text = L"Ïðî÷íîñòü ïðîôèëÿ -";
			// 
			// _l_digging_anker
			// 
			...
			this->_l_digging_anker->Text = L"Âûðûâ àíêåðà -";
			// 
			// _l_connections
			// 
			...
			this->_l_connections->Text = L"Ñîåäèíåíèÿ -";
			// 
			// _l_qy
			// 
			...
			this->_l_sp_20_13330_2011->Text = L"- ÑÏ 20.13330.2011";
			// 
			...
			this->_chb_aerodynamic_factor->Text = L"Àýðîäèíàìè÷åñêèé êîýôôèöèåíò:";
			...
			this->_tb_height->Text = L"Çàïîëíÿåò èíæåíåð";
			...
			this->_tb_responsible->Text = L"Çàïîëíÿåò èíæåíåð";
			...
			this->_tb_code->Text = L"Çàïîëíÿåò èíæåíåð";
			...
			this->_tb_name->Text = L"Çàïîëíÿåò èíæåíåð";
			...
			this->_l_responsible->Text = L"Îòâåòñòâåííûé:";
			// 
			// _l_code
			// 
			...
			this->_l_h_step_profile->Text = L"Øàã ãîðèçîíòàëüíîãî ïðîôèëÿ:";
			// 
			// _tb_v_step_profile
			// 
			...
			this->_l_v_step_profile->Text = L"Øàã âåðòèêàëüíîãî ïðîôèëÿ:";
			// 
			...
			this->_tb_h_step_bracket_marginal_area->Text = L"ÊÇ";
			...
			this->_tb_h_step_bracket_ordinary_area->Text = L"ÐÇ";
			...
			this->_l_h_step_bracket->Text = L"Ãîðèçîíòàëüíûé øàã êðîíøòåéíîâ:";
			// 
			...
			this->_tb_v_step_bracket_marginal_area->Text = L"ÊÇ";
			...
			this->_tb_v_step_bracket_ordinary_area->Text = L"ÐÇ";
			...
			this->_l_v_step_bracket->Text = L"Âåðòèêàëüíûé øàã êðîíøòåéíîâ:";
			// 
			// _tb_facing_radius
			// 
			...
			this->_l_facing_radius->Text = L"Âûëåò îáëèöîâêè:";
			// 
			// _l_constructions
			// 
			...
			this->_l_constructions->Text = L"ÊÎÍÑÒÐÓÊÖÈÈ";
			// 
			// _pnl_variation
			// 
			...
			this->_tb_conclusion->Text = L"Âûâîä";
