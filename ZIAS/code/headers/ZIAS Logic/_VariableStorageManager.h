...
namespace zias {
	...
	private:		
		...
		static void calculate_H_2(std::shared_ptr<Subsystem> my_subsystem, const float& my_v_step_profile_marginal_area);
		static void calculate_H_3(std::shared_ptr<Subsystem> my_subsystem, const float& my_h_step_profile);
		static void calculate_B_1(std::shared_ptr<Subsystem> my_subsystem, const float& my_v_step_bracket_ordinary_area, const float& my_h_step_bracket_ordinary_area);
		static void calculate_B_2(std::shared_ptr<Subsystem> my_subsystem, const float& my_v_step_bracket_marginal_area, const float& my_h_step_bracket_marginal_area);
		static void calculate_q_H_1(std::shared_ptr<Subsystem> my_subsystem);
		static void calculate_q_H_2(std::shared_ptr<Subsystem> my_subsystem);
		static void calculate_q_H_3(std::shared_ptr<Subsystem> my_subsystem);
		static void calculate_q_sum_1(std::shared_ptr<Subsystem> my_subsystem);
		static void calculate_q_sum_2(std::shared_ptr<Subsystem> my_subsystem);
		...
		static void calculate_q_321();
		static void calculate_q_411();
		static void calculate_S_1(std::shared_ptr<Subsystem> my_subsystem);
		static void calculate_P_1();
		static void calculate_N_1();
		static void calculate_P_2();
		static void calculate_N_2();
		static void calculate_S_2(std::shared_ptr<Subsystem> my_subsystem);
		static void calculate_P_3(std::shared_ptr<Subsystem> my_subsystem);
		static void calculate_N_3();
		static void calculate_qy_0();
		static void calculate_qy_1();
		static void calculate_qz_0();
		static void calculate_qz_1(std::shared_ptr<Subsystem> my_subsystem);
		static void calculate_R_1_1(std::shared_ptr<Subsystem> my_subsystem, std::shared_ptr<Bracket> my_bracket, const float& my_facing_radius);
		static void calculate_R_2_1(std::shared_ptr<Subsystem> my_subsystem, std::shared_ptr<Bracket> my_bracket, const float& my_facing_radius);
		static void calculate_R_3_1(std::shared_ptr<Subsystem> my_subsystem, std::shared_ptr<Bracket> my_bracket, const float& my_facing_radius);
		static void calculate_R_1_2(std::shared_ptr<Subsystem> my_subsystem, std::shared_ptr<Bracket> my_bracket, const float& my_facing_radius);
		static void calculate_R_2_2(std::shared_ptr<Subsystem> my_subsystem, std::shared_ptr<Bracket> my_bracket, const float& my_facing_radius);
		static void calculate_R_3_2(std::shared_ptr<Subsystem> my_subsystem, std::shared_ptr<Bracket> my_bracket, const float& my_facing_radius);
		static void calculate_digging_anker();
